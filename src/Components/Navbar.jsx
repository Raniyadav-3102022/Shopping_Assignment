                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    ...
                                    <Link to="/shop" className="text-dark-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Shop</Link>
                                    <Link to="/magzine" className="text-dark-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Magzine</Link>
                                </div>
                            </div>
                        </div>
